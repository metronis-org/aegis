...
def upgrade() -> None:
    ...
    op.create_index('idx_org_domain_created', 'traces', ['organization_id', 'domain', 'created_at'])
    ...
    op.create_table(
        ...
        sa.Column('overall_severity', sa.Enum('LOW', 'MEDIUM', 'HIGH', 'CRITICAL', name='severity'), nullable=True),
        sa.Column('status', sa.Enum('PENDING', 'RUNNING', 'COMPLETED', 'FAILED', name='evaluationstatus'), nullable=True),
    ...
    op.create_index('idx_trace_created', 'evaluation_results', ['trace_id', 'created_at'])
    ...
    op.create_index('ix_evaluation_issues_issue_type', 'evaluation_issues', ['issue_type'])
    op.create_index('ix_evaluation_issues_severity', 'evaluation_issues', ['severity'])
    op.create_index('idx_eval_severity', 'evaluation_issues', ['evaluation_id', 'severity'])
    ...
    op.create_index('idx_domain_tier_prod', 'model_versions', ['domain', 'tier', 'is_production'])
