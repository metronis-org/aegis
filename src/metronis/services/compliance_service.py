...
class ComplianceService:
    ...
    def generate_fda_tplc_report(
        ...
        pass_rate = (
            (passed_evaluations / total_evaluations * 100)
    ...
    def generate_hipaa_report(
        ...
        phi_detected = sum(
            1 for t in traces if t.metadata and t.metadata.get("phi_detected")
        )
        ...
        report = {
            ...
            "phi_handling": {
                ...
                "phi_detection_rate": (
                    round(phi_detected / len(traces) * 100, 2) if traces else 0
                ),
            ...
            audit_entries.append(
                {
                    ...
                    "phi_detected": (
                        trace.metadata.get("phi_detected", False)
                        if trace.metadata
                        else False
                    ),
                }
